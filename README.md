...
Юнит-тесты запускаются из корневого каталога командами типа:
```
python -m unittest /home/okami/PycharmProjects/medrating2/tests/test_content.py
``` 
Для примера написано 5 тестов, один из которых падает, указывая на необходимость доработки кода.